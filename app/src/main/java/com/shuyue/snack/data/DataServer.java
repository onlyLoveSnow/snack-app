...
public class DataServer {
    ...
    public static List<Snack> getFujianList() {
        return new ArrayList<Snack>() {{
            ...
            add(new Snack("板栗饼", 7, R.mipmap.banlibing, "板栗饼是一种食品。它以纯天然板栗，优质花生油为主要原料，按历代相传的手工工艺精制而成，是闽北传统名点之一，最早发源于福建地区。"));
            add(new Snack("荔枝肉", 15, R.mipmap.lizhirou, "荔枝肉是福建省福州、莆田等地特色传统名菜，属于闽菜。已有二三百年历史。因原料中有白色的荸荠和切成十字花刀的猪肉，烹调后因外形型似荔枝而得名。"));
            add(new Snack("牛肉兜汤", 20, R.mipmap.niuroudoutang, "兜汤，传统小吃，属于客家菜。兜汤名字来由，有两种：1、做兜汤的时候，所有食材都是放在一个漏罩里兜着，烫熟后再放入碗里，所以有兜着做的意思，因此叫“兜汤”；2、客家语中，“端”（本意是端在手上）发成“兜”（dou)，端着吃的汤。为什么端着吃，因为这类汤的最早是穿大街走小巷的商贩制作的（在古代所有商贩都是挑着担满街走），后由于美味可口，因此客家人习惯性把这类做法的汤取名叫兜汤。"));
            add(new Snack("佛跳墙", 500, R.mipmap.fotiaoqiang, "佛跳墙，又名福寿全，是福建福州的当地名菜，属闽菜系。相传，它是在清道光年间由福州聚春园菜馆老板郑春发研制出来的，又据费孝通先生记，发明此菜者乃一 帮要饭的乞丐。"));
        }};
    }
